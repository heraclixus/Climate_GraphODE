"""
3D FNO for time series based predictions
in this case input is of shape (batch_size, x, y, c_in, t) for training
and output is of shape (batch_size, x, y, c_out) 
...
class FNO_space2D_time(nn.Module):
    def __init__(self, modes1, modes2, modes3, vars, width, L, T):
